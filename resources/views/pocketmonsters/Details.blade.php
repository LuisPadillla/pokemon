    ...
    <div class="container">
        <div class="row">
            <div class="card col-md-12">
                <div class="card-body">
                    <h1 class="card-title"><b>{{ $pocketmonster->name}}</b></h1>
                    <h3 class="card-subtitle mb-2 text-muted">{{ $pocketmonster->pokedex_number}}</h3>
                    <p class ="card-text">{{$pocketmonster->generation}}</p>
                </div>
            ...
            <div class="col-md-12">
                ...
                <form action="/pocketmonsters/comment" method="POST">
                    @csrf
            ...
            <div class="col-md-12">
                ...
                @if (count($pocketmonster->Comments) == 0 || $pocketmonster->Comments == null || empty($pocketmonster->Comments))
                    <h5 class="text-muted">No comments yet.</h5>
                @else
                    @foreach ($pocketmonster->Comments as $comment)
                    <div class="card col-md-12">
                        <div class="card-body">
            ...
            &nbsp&nbsp&nbsp&nbsp<a href="/pocketmonsters/" class="btn btn-light btn-lg active">Back</a>
        </div>
    </div>
@endsection