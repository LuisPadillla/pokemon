    ...
    <div class="container">
        <div class="row">
            <div class="card col-md-12">
                <div class="card-body">
                    <h1 class="card-title"><b>{{ $combat->First_pokemon}}</b></h1>
                    <h3 class="card-subtitle mb-2 text-muted">{{ $combat->Second_pokemon}}</h3>
                    <p class ="card-text">{{$combat->Winner}}</p>
                </div>
            ...
            <div class="col-md-12">
                ...
                <form action="/combats/comment" method="POST">
                    @csrf
            ...
            <div class="col-md-12">
                ...
                @if (count($combat->Comments) == 0 || $combat->Comments == null || empty($combat->Comments))
                    <h5 class="text-muted">No comments yet.</h5>
                @else
                    @foreach ($combat->Comments as $comment)
                    <div class="card col-md-12">
                        <div class="card-body">
            ...
            &nbsp&nbsp&nbsp&nbsp<a href="/combats/" class="btn btn-light btn-lg active">Back</a>
        </div>
    </div>
@endsection